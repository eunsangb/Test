...
//		prop.put(true, 123123);
		...
		//.setProperty(), .getProperty()를 이용하여 문자열타입의 key-value쌍을 관리한다
...
//		prop.setProperty("A", 100);
		...
		prop.setProperty("password", "Alic123");
		...
		try {
			writer = new FileWriter("C:\\workspace\\JavaBasic\\src\\java10_collection\\user.properties");
		...
		try {
			reader = new FileReader("C:\\workspace\\JavaBasic\\src\\java10_collection\\user.properties");
