...
class Child extends Parent{  //자식 클래스
	...
	@Override
	public void display() {
		System.out.println("오버라이딩 메소드");  //오버라이딩 : 재정의 - 상속
	}
	
	public void display(int num) {
		System.out.println("오버라이딩한 메소드를 오버로딩한 메소드");  //오버로딩 : 중복 정의 - 같은 클래스
	}  
	
	//** 오버라이딩, Overriding
	//	메소드 재정의
	//	상속받은 메소드의 기능을 재정의 하는 것
	//	-> 부모 클래스에 정의된 리턴타입, 이름, 매개변수 형시과 같아야 한다
	//** @Override 어노테이션
	...
	//	특정한 동작, 문법, 코드 등을 간단히 적용할 수 있도록 되어있다
